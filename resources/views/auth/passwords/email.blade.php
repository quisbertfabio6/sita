...
<head>
    ...
    <title>Recuperar Contraseña - SITA</title>
        ...
        <div class="login-form-section">
            ...
            <div class="login-card">
                <div class="mb-4">
                    ...
                    <h2 class="login-subtitle">Recuperar Acceso</h2>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Tu correo registrado..." required autofocus>
                        </div>
                        @error('email')
